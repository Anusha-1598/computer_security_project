...
from lib.db.db import register_user, login_user, insert_encryption, get_encryption, getDocuments, getSharedDocuments as getSharedDocs, getDocumentContent as getDocContent, deleteDocument as deleteDoc,renameDocument as renameDoc, updateFilePermissions as updateFileAccess, newFile as newFileDoc, saveDocumentContent as saveDoContent, logout as logout_user
...
cors = CORS(app, supports_credentials=True,resources={r'/verifyCookie':{'origins':'http://127.0.0.1:3000',"allow_headers": ["Content-Type", "Authorization", "X-Requested-With"],
        "methods": ["GET", "POST", "OPTIONS", "PUT", "DELETE"],"expose_headers": ["Content-Disposition"]}})
@app.after_request
